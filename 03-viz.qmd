...
## Walkthrough video {#sec-walkthrough-viz}
...
So far we've just knitted to html. To generate PDF reports, you need to install `r pkg("tinytex")` [@R-tinytex] and run the following code in the console (do **not** add this to your Rmd file):
