...
:::{.callout-tip}
You can comment out multiple lines by selecting them with your cursor and choosing **`Comment/Uncomment Lines`** from the **`Code`** menu (or using the keyboard shortcut).
:::
