...
For reference, here are the packages we will use in this chapter. You may need to install them, as explained in @sec-install-package, if running the code below in the console pane gives you an error. 
...
Once you've done this, update your YAML heading to replace `html_dcoument` with `pdf_document` and knit a PDF document.
...
You can access a [working R Markdown file](demos/important_info.Rmd){download="important_info.Rmd"} with the code from the example above to compare to your own code.
