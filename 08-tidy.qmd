...
## Intended Learning Outcomes {#sec-ilo-tidy}
...
## Walkthrough video {#sec-walkthrough-tidy}
...
kable(wide_totalprice, caption = "Wide data")
```
...
```{r, echo = FALSE}
kable(long_totalprice, caption = "Long data")
```
...
`r kable(wide_by_customer, caption = "Data made wider with pivot_wider()")`
