...
For this chapter, we'll use data scraped from Twitter using `r pkg("rtweet")`. In order to use these functions, you need to have a Twitter account. Don't worry if you don't have one; we'll provide the data in the examples below for you.
...
* Work through the further examples in @sec-twitter-hashtags).
