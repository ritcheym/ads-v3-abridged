...
This chapter describes a formative exercise for this class. If you are not part of the Applied Data Skills microcredential class, you can ignore the instructions about Moodle and submission, but the formative exercise is still valuable practice.
...
-   There are two files you need to download. The first is the dataset: <a href="https://psyteachr.github.io/ads-v2/data/review_data.csv" download>review_data.csv</a>. The second is the finished report that you need to backwards engineer from the data: [formative_report_output.html](https://psyteachr.github.io/ads-v2/data/formative_report_output.html).
