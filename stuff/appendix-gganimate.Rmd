...
The code below uses the [ncod_tweets.rds](data/ncod_tweets.rds){download} data from Appendix\ @sec-twitter-hashtags). It's complex, but it's all functions you've learned how to use. 
